# -*- coding: utf-8 -*-
"""
Prediction about superconducting critical temperature Tc of hydrides

A. Make csv files
A1. convert tc.csv -> tc_data.csv
    chemical formula -> parameters(atomic number & number of atoms)
...
----------
tc.csv:
    chemical formula, space group, pressure,
    electron-phonon interaction lambda,
    logarithmic average phonon frequency, omega_log,
    screened coulomb interaction mu*, 
    superconducting critical temperature Tc,
    reference (doi) of paper,
    of already reported materials.
...
tc_pred.csv:
    ...
    Tc to be calculated. All Tc are set to 0 K.
...
-----------------------------------
Created on Wed Dec 19 13:33:56 2018
