...
def print_search_score(grid_search,X_train,y_train): #{{{
    ...
    print('  ave, std = %0.3f (+/-%0.03f)' % (scores.mean(), scores.std()*2 ))
...
#   print('grid_search.cv_results_ = ',grid_search.cv_results_)
    print('')
    i_best_params=grid_search.cv_results_['params'].index(grid_search.best_params_)
    score0=grid_search.cv_results_['split0_test_score'][i_best_params]
    score1=grid_search.cv_results_['split1_test_score'][i_best_params]
    score2=grid_search.cv_results_['split2_test_score'][i_best_params]
    score3=grid_search.cv_results_['split3_test_score'][i_best_params]
    score4=grid_search.cv_results_['split4_test_score'][i_best_params]
    print('grid_search.cv_results_[params] = ',i_best_params)
    print('grid_search.cv_results_[split0_test_score] = ',score0)
    print('grid_search.cv_results_[split1_test_score] = ',score1)
    print('grid_search.cv_results_[split2_test_score] = ',score2)
    print('grid_search.cv_results_[split3_test_score] = ',score3)
    print('grid_search.cv_results_[split4_test_score] = ',score4)
    print('  ave = %.3f' % ( (score0+score1+score2+score3+score4)/5.0))
#   print('')
