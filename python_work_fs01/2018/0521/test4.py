...
svrgammas   = 2**np.arange( -10,  0, dtype=float)
nfold = 5
ntrain = 10
ntest  = 10
...
for svrgamma in svrgammas:
    ...
    print(grammatrix-rbf_kernel(np_std_Xtrain, gamma=svrgamma))
#   print('{0[0]:.3f}, {0[1]:.3f}, {0[2]:.3f}, {0[3]:.3f}'.format(grammatrix[0]))
#   print('{0[0]:.3f}, {0[1]:.3f}, {0[2]:.3f}, {0[3]:.3f}'.format(grammatrix[1]))
#   print('{0[0]:.3f}, {0[1]:.3f}, {0[2]:.3f}, {0[3]:.3f}'.format(grammatrix[2]))
#   print('{0[0]:.3f}, {0[1]:.3f}, {0[2]:.3f}, {0[3]:.3f}'.format(grammatrix[3]))
